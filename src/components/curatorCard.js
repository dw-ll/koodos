...
const CurationInfoRow = tw.article`flex flex-col z-20 justify-center md:justify-start items-center text-center w-full md:mx-1 px-4 md:px-12 py-1 md:py-3 space-y-2 md:space-x-8`
